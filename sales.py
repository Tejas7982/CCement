...
def main():
    ...
    <h2 style="color:Black;text-align:center;">Forecasting </h2>
    </div>
    ...
    html_temp = """
    <div style="background-color:GreenYellow;padding:10px">
    <p style="color:black;text-align:center;">Add DataBase Credientials </p>
    </div>
    """
    ...
    if st.button("Predict"):
        ...
        st.text("")
        st.subheader(":red[Forecast for the next 12 months]", anchor=None)
